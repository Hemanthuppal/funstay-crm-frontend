...
const EditOppLead = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const opportunityData = {
      ...
      child_ages: formData.child_ages.join(','), // This will create a string like '9,10'
              ...
              <Form.Group className="mb-3">
                <div>
                  <Form.Check
                    ...
                    type="radio"
                    value="individual"
                    checked={formData.lead_type === 'individual'}
                  ...
                  <Form.Check
                    ...
                    type="radio"
                    value="group"
                    checked={formData.lead_type === 'group'}
                    onChange={handleLeadTypeChange}
                  />
                  <Form.Check
                    inline
                    ...
                    type="radio"
                    value="corporate"
                    checked={formData.lead_type === 'corporate'}
                    onChange={handleLeadTypeChange}
                  />
                </div>
              </Form.Group>
                    ...
                    <Col md={4}>
                      <Form.Group className="mb-3">
                        ...
                        <Form.Select
                          ...
                          onChange={handleChange}
                          disabled={!formData.secondaryStatus}
                        >
                          <option value="">Select Status</option>
