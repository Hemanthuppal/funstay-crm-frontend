...
const CreateCustomerOpportunity = () => {
  ...
  const handleDurationChange = (e) => {
    ...
    setDuration(value); // Allow user to edit duration manually
    ...
    if (startDate && value) {
      ...
      setEndDate(newEndDate.toISOString().split("T")[0]); // Format to YYYY-MM-DD
    }
  };
            ...
            <div className="createcustomer-form-grid">
              ...
              <div className="createcustomer-input-group">
                ...
                <input
                  type="text"
                  value={duration}
                  onChange={handleDurationChange} // Make duration editable
                />
              </div>
