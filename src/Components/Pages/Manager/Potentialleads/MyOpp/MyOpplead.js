...
import { FaEdit, FaEye,FaDownload, FaComment, FaTrash, FaCalendarAlt,FaSave, FaTimes, FaCopy ,FaSpinner} from "react-icons/fa";
    ...
    },
    {
      ...
      Cell: ({ row }) => {
        ...
        const handleNavigate = () => {
          navigate(`/m_myemail-history/${row.original.leadid}`, { 
