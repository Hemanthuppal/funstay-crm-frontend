...
const EditLeadOppView = () => {
    ...
    const [editCustomerMode, setEditCustomerMode] = useState(false); // Toggle for Customer Edit Mode
    ...
    const handleCustomerSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`${baseURL}/api/customers/${customerId}`, customer);
            alert("Customer details updated successfully!");
            setEditCustomerMode(false); // Exit edit mode after saving
        } catch (err) {
                                                                ...
                                                                {!editOpportunityMode[index] ? (
                                                                    <Button
                                                                        ...
                                                                        onClick={(e) => {
                                                                            ...
                                                                            setEditOpportunityMode({ ...editOpportunityMode, [index]: true });
                                                                        }}
                                                                    >
                                                                        Edit 
                                                                    </Button>
