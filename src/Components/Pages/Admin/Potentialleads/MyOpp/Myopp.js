...
import { FaEdit, FaDownload, FaEye, FaComment, FaTrash, FaCalendarAlt, FaTimes, FaCopy ,FaSave,FaSpinner} from "react-icons/fa";
    ...
    },
    {
      ...
      Cell: ({ row }) => {
        ...
        const handleNavigate = () => {
          navigate(`/a_myemail-history/${row.original.leadid}`, { 
