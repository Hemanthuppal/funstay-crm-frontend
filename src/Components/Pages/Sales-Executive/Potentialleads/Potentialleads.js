...
import { FaEdit, FaDownload, FaEye, FaComment, FaTrash, FaCalendarAlt,FaSave, FaTimes, FaCopy,FaSpinner, } from "react-icons/fa";
    ...
    },
    {
      ...
      Cell: ({ row }) => {
        ...
        const handleNavigate = () => {
          navigate(`/s_email-history/${row.original.leadid}`, { 
